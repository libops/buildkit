...
Docker image for [scyllaridae] 5.2.10.
...
Requires `libops/base` and `libops/go:1.26` Docker images to build. Please refer
to the [Base Image README](../base/README.md) and
[Go 1.26 Image README](../go1.26/README.md) for additional information.
...
[scyllaridae]: https://github.com/libops/scyllaridae
