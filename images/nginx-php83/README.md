...
Built from [libops/isle-buildkit nginx-php83](https://github.com/libops/buildkit/tree/main/images/nginx-php83)
...
[`libops/php:8.3`](../php83/README.md) image, so PHP-FPM settings are
inherited from that image.

## Dependencies

Requires `libops/php:8.3` Docker image to build. Please refer to the
[PHP 8.3 Image README](../php83/README.md) for additional information.
