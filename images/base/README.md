...
Built from [libops/isle-buildkit base](https://github.com/libops/buildkit/tree/main/images/base)

It's based off off [Alpine Linux], and includes [s6 overlay] and [confd].

The runtime also includes GNU tar. Operator tooling may rely on GNU tar's
hard-link and delayed-directory-restore behavior for transactional volume
backup and restore.
...
The base image uses [confd] to render templates from environment variables.
